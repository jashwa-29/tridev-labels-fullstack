    ...
    if (!resetToken) {
        return (
            <div className="min-h-screen flex items-center justify-center p-4 bg-slate-50">
                 <div className="text-center bg-white p-12 rounded-3xl shadow-xl border border-slate-100 max-w-sm">
                    <AlertCircle className="size-16 text-red-600 mx-auto mb-6" />
                    <h2 className="text-2xl font-black mb-4">Invalid Access</h2>
                    <p className="text-slate-500 mb-8">This reset link is invalid or has expired.</p>
                    <button onClick={() => router.push("/admin")} className="admin-btn-primary w-full py-4 shadow-lg shadow-red-100">Go to Login</button>
                 </div>
            </div>
        );
    }
            ...
            <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl shadow-slate-200/50 p-8 sm:p-12 relative z-10 border border-slate-100">
                <div className="text-center mb-10">
                    <div className="flex justify-center mb-6">
                        <img src="/tridev-logo.png" alt="Tridev Labels" className="h-12 object-contain" />
                    </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="space-y-2">
                        ...
                        <div className="relative group">
                            ...
                            <input
                                ...
                                className="admin-input-field admin-input-field-icon pl-12 h-14 w-full bg-slate-50 border-slate-200 focus:bg-white transition-all"
                                required
                            />
                        </div>
                    </div>
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="admin-btn-primary w-full h-14 text-base shadow-lg shadow-red-600/20 hover:shadow-red-600/30 transition-all active:scale-[0.98]"
                    >
                        {loading ? (
