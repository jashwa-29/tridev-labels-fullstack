...
import { serviceService } from '@/components/admin/services/service.service';
...
import { Toast, DeleteModal, SuccessModal } from '@/components/admin/ui';
...
const ServicesPage = () => {
  ...
  const getInputClassName = (value, isRequired = false) => {
    const baseClass = "admin-input-field";
              ...
              <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between border-b border-slate-50 bg-slate-50/50 p-8 md:p-10">
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    ...
                    <div className="text-[10px] font-bold uppercase tracking-widest text-slate-400 mt-1.5 flex items-center gap-2">
                ...
                <div className="flex gap-3">
                  <button type="button" onClick={clearForm} className="admin-btn-secondary h-12 rounded-xl">Discard</button>
                  <button onClick={handleSubmit} disabled={isSubmitting} className="admin-btn-primary h-12 min-w-[160px] rounded-xl">
                    {isSubmitting ? (
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                            ...
                            <div className="space-y-4">
                              <div className="flex items-center justify-between">
                                ...
                                <span className="text-[10px] font-bold text-slate-300 bg-slate-50 px-2 py-1 rounded-md">1200 Ãƒâ€” 800px</span>
                              </div>
                            ...
                            <div className="space-y-4">
                              <div className="flex items-center justify-between">
                                ...
                                <span className="text-[10px] font-bold text-slate-300 bg-slate-50 px-2 py-1 rounded-md">800 Ãƒâ€” 600px</span>
                              </div>
                              ...
                              <div className="relative w-full max-w-4xl max-h-[90vh] overflow-y-auto rounded-[2rem] bg-white shadow-2xl animate-in zoom-in-95 duration-300">
                                    ...
                                    <div className="flex items-center justify-between">
                                      ...
                                      <div className="flex items-center gap-3">
                                        <div className="px-3 py-1.5 bg-purple-50 rounded-lg border border-purple-100">
                                          <p className="text-[10px] font-bold text-purple-600">Hero: 2100Ãƒâ€”900px | Gallery: 800Ãƒâ€”800px</p>
                                        </div>
                                        <div className="group/tip relative">
                                          ...
                                          <div className="absolute right-0 top-8 z-50 w-72 p-4 bg-slate-900 text-white rounded-xl shadow-2xl opacity-0 invisible group-hover/tip:opacity-100 group-hover/tip:visible transition-all duration-200">
                                            <p className="text-[11px] font-bold mb-3">Ã°Å¸â€œÂ Image Size Guide:</p>
                                            <div className="space-y-2">
                                              <div className="p-2 bg-white/10 rounded-lg">
                                                <p className="text-[10px] font-bold text-purple-300 mb-1">Hero Image (First Upload)</p>
                                                <p className="text-[9px] leading-relaxed">2100Ãƒâ€”900px (21:9 ratio)</p>
                                              ...
                                              <div className="p-2 bg-white/10 rounded-lg">
                                                ...
                                                <p className="text-[9px] leading-relaxed">800Ãƒâ€”800px (1:1 ratio)</p>
                                ...
                                <div className="sticky bottom-0 z-10 border-t border-slate-100 bg-slate-50/80 backdrop-blur-md p-6 flex justify-end">
                                  <button 
                                    type="button" 
                                    onClick={() => setExpandedSubProduct(null)} 
                                    className="admin-btn-primary h-11 px-8 rounded-xl shadow-lg"
                                  >
                             ...
                             <div className="space-y-6">
                               {newService.sections.map((section, i) => (
                                <div key={i} className="p-6 bg-white rounded-2xl border border-slate-200">
                                  ...
                                  <div className="space-y-4">
                                    <input type="text" placeholder="Section Heading" value={section.heading} onChange={(e) => handleSectionChange(i, "heading", e.target.value)} className="admin-input-field text-base font-bold" />
                               ...
                               <div className="space-y-3">
                                {newService.specs.map((spec, i) => (
                                  <div key={i} className="flex gap-3">
                                    <input type="text" placeholder="Label" value={spec.label} onChange={(e) => handleSpecChange(i, "label", e.target.value)} className="flex-1 admin-input-field h-9 text-xs" />
                                    <input type="text" placeholder="Value" value={spec.value} onChange={(e) => handleSpecChange(i, "value", e.target.value)} className="flex-1 admin-input-field h-9 text-xs" />
                            ...
                            <div className="p-6 bg-slate-50/50 rounded-[2rem] border border-slate-100">
                               ...
                               <div className="space-y-3">
                                {newService.applications.map((app, i) => (
                                  <div key={i} className="flex gap-3">
                                    <input type="text" placeholder="Application" value={app} onChange={(e) => handleApplicationChange(i, e.target.value)} className="flex-1 admin-input-field h-9 text-xs" />
                             ...
                             <div className="space-y-4">
                               {newService.faqs.map((faq, i) => (
                                <div key={i} className="p-4 bg-white rounded-2xl border border-slate-200 space-y-3 relative">
                                  ...
                                  <input type="text" placeholder="Question" value={faq.question} onChange={(e) => handleFAQChange(i, "question", e.target.value)} className="admin-input-field font-bold text-xs" />
                                  <textarea placeholder="Answer" value={faq.answer} onChange={(e) => handleFAQChange(i, "answer", e.target.value)} rows={2} className="admin-input-field resize-none text-xs" />
                                </div>
                              ))}
                             </div>
                          </div>
                        ...
                        <div className="p-6 bg-slate-50/50 rounded-[2rem] border border-slate-100 space-y-6">
                          ...
                          <div className="space-y-1.5">
                            ...
                            <textarea
                              ...
                              className="admin-input-field resize-none"
                            />
                      ...
                      <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                        ...
                        <div className="p-6 bg-slate-50/50 rounded-[2rem] border border-slate-100 space-y-8">
                           ...
                           <div className="bg-blue-50/50 rounded-xl p-4 border border-blue-100">
                              ...
                              <button onClick={handleSubmit} disabled={isSubmitting} className="admin-btn-primary w-full justify-center">
            ...
            <div className="space-y-6">
              ...
              {isLoading ? (
                ...
                <div className="flex h-80 flex-col items-center justify-center rounded-[2.5rem] border border-dashed border-slate-200 bg-white p-12 text-center">
                  ...
                  <button onClick={() => setShowForm(true)} className="mt-6 admin-btn-primary">
                    <Plus size={18} />
