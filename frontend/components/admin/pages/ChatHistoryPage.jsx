...
import { Toast, Pagination } from '@/components/admin/ui';
        ...
        <div className="flex items-center gap-3">
          <div className="relative">
            ...
            <input 
              ...
              className="admin-input-field admin-input-field-icon !h-12 pl-12 w-64 !bg-white focus:ring-4 focus:ring-red-500/10"
            />
          </div>
          <button 
                    ...
                    <td className="px-8 py-6 text-right relative">
                      <div className="flex items-center justify-end gap-4">
                        ...
                        <button 
                          ...
                          className="opacity-0 group-hover:opacity-100 admin-btn-primary !h-10 !px-4 !text-[10px] shadow-lg shadow-red-100"
                        >
                          <Eye size={14} />
        ...
        <div className="fixed inset-0 z-[110] flex items-center justify-center p-4 backdrop-blur-md">
          ...
          <div className="relative w-full max-w-2xl overflow-hidden rounded-[2.5rem] bg-white shadow-2xl animate-in zoom-in-95 duration-300">
            ...
            <div className="border-t border-slate-100 p-8 bg-white flex justify-end">
              <button
                onClick={() => setShowModal(false)}
                className="admin-btn-primary min-w-[140px] shadow-xl shadow-red-200"
              >
                Close Transcript
              </button>
            </div>
