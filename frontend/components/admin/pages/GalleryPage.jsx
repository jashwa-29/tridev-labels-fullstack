...
const GalleryPage = () => {
  ...
  useEffect(() => {
    ...
    fetchGallery();
  }, [token, router, fetchGallery]); // Added fetchGallery to dependencies
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea
                    ...
                    className="admin-input-field min-h-[120px]"
                  />
                </div>
              ...
              <div className="space-y-6">
                 ...
                 <div className="grid grid-cols-2 gap-4">
                   ...
                   <button
                     type="submit"
                     disabled={submitting}
                     className="admin-btn-primary w-full py-4 rounded-2xl"
                   >
                     {submitting ? (
      ...
      <div className="space-y-10 mt-12">
        ...
        {loading && galleryItems.length === 0 ? (
          ...
          <div className="flex h-[400px] flex-col items-center justify-center rounded-[4rem] border border-dashed border-slate-200 bg-white p-12 text-center">
            ...
            {!showForm && <button onClick={() => setShowForm(true)} className="mt-8 admin-btn-primary h-12 px-8">Initialize First Finish</button>}
          </div>
        )}
      </div>
