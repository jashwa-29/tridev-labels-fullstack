  ...
  if (!blog) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
        ...
        <Link href="/admin/dashboard/blogs" className="admin-btn-primary">
          <ArrowLeft size={18} />
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-12 animate-in fade-in slide-in-from-bottom-8 duration-700">
      ...
      <div className="flex items-center justify-between mb-12">
        <Link href="/admin/dashboard/blogs" className="group flex items-center gap-3 text-slate-400 hover:text-black transition-colors">
      ...
      <div className="mt-12 text-center">
        ...
        <div className="flex justify-center gap-4">
          <Link href="/admin/dashboard/blogs" className="admin-btn-secondary h-12">
            Return to Management
          </Link>
          <button onClick={handleCopyLink} className="admin-btn-primary h-12 px-8">
            <Share2 size={18} />
