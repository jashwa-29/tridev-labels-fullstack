...
const TestimonialsPage = () => {
  ...
  useEffect(() => {
    ...
    fetchTestimonials();
  }, [router, token, fetchTestimonials]);
        ...
        <div className="flex items-center gap-3">
          <div className="relative">
            ...
            <input 
              ...
              className="admin-input-field admin-input-field-icon !h-12 pl-12 w-64 !bg-white" 
            />
          </div>
          {!showForm && (
            <button 
              onClick={() => setShowForm(true)}
              className="admin-btn-primary h-12 px-8 shadow-xl shadow-red-200"
            >
              <Plus size={20} />
              <span>New Voice</span>
            </button>
              ...
              <div className="space-y-6">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                       ...
                       <input
                        ...
                        className="admin-input-field admin-input-field-icon pl-10"
                      />
                    </div>
                  </div>
                  <div className="space-y-1.5">
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea
                    ...
                    className="admin-input-field min-h-[150px] italic"
                    required
                  />
                </div>
              ...
              <div className="space-y-6">
                 ...
                 <div className="pt-6 space-y-6">
                    ...
                    <button
                        type="button"
                        onClick={handleReset}
                        className="admin-btn-secondary w-full py-4 rounded-2xl"
                    >
                        Discard Changes
                    </button>
                    <button
                        type="submit"
                        disabled={submitting}
                        className="admin-btn-primary w-full py-4 rounded-2xl shadow-xl shadow-red-200"
                    >
                        {submitting ? (
      ...
      <div className="space-y-10 mt-12 pb-20">
        ...
        {loading && testimonials.length === 0 ? (
          ...
          <div className="flex h-[400px] flex-col items-center justify-center rounded-[4rem] border border-dashed border-slate-200 bg-white p-12 text-center">
            ...
            {!showForm && <button onClick={() => setShowForm(true)} className="mt-8 admin-btn-primary h-12 px-8">Initialize First Voice</button>}
          </div>
        )}
      </div>
