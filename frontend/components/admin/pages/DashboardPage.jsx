...
import { quoteService } from '@/components/admin/services/quote.service';
import { contactService } from '@/components/admin/services/contact.service';
...
import { specialService } from '@/components/admin/services/special.service';
...
const DashboardPage = () => {
  ...
  const StatCard = ({ title, value, icon: Icon, trend, color, link }) => (
    <Link href={link || '#'} className="group relative overflow-hidden rounded-[2rem] bg-white p-6 shadow-sm ring-1 ring-slate-100 transition-all hover:shadow-md hover:ring-slate-200">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="rounded-[2.5rem] bg-white p-8 shadow-sm ring-1 ring-slate-100 overflow-hidden">
            <div className="mb-8 flex items-center justify-between">
              ...
              <Link href="/admin/dashboard/quotes" className="group flex items-center gap-2 text-xs font-black uppercase tracking-widest text-red-600 hover:text-black transition-colors">
          ...
          <div className="grid gap-6 sm:grid-cols-3">
             <Link href="/admin/dashboard/services" className="group rounded-[2rem] bg-slate-900 p-6 text-white shadow-lg transition-all hover:-translate-y-2 hover:shadow-2xl">
             ...
             <Link href="/admin/dashboard/blogs" className="group rounded-[2rem] bg-white p-6 shadow-sm ring-1 ring-slate-100 transition-all hover:-translate-y-2 hover:shadow-lg">
             ...
             <Link href="/admin/dashboard/gallery" className="group rounded-[2rem] bg-white p-6 shadow-sm ring-1 ring-slate-100 transition-all hover:-translate-y-2 hover:shadow-lg">
          ...
          <div className="rounded-[2.5rem] bg-slate-900 p-8 text-white shadow-xl h-full border border-white/5 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-4">
                <Link href="/admin/dashboard/gallery" className="flex items-center justify-between p-4 rounded-2xl bg-white/5 border border-white/5 group hover:bg-white/10 transition-all">
                  <div className="flex items-center gap-3">
                ...
                <Link href="/admin/dashboard/testimonials" className="flex items-center justify-between p-4 rounded-2xl bg-white/5 border border-white/5 group hover:bg-white/10 transition-all">
                  <div className="flex items-center gap-3">
                ...
                <Link href="/admin/dashboard/specials" className="flex items-center justify-between p-4 rounded-2xl bg-white/5 border border-white/5 group hover:bg-white/10 transition-all">
                  <div className="flex items-center gap-3">
