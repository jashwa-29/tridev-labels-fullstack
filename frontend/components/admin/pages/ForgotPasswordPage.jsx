...
function ForgotPasswordPage() {
    ...
    const handleVerifyOtp = async (e) => {
        ...
        try {
            ...
            router.push(`/admin/reset-password?token=${res.resetToken}`);
        } catch (err) {
        ...
        <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl shadow-slate-200/50 p-8 sm:p-12 relative z-10 border border-slate-100">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className="admin-input-field admin-input-field-icon pl-12 h-14 w-full bg-slate-50 border-slate-200 focus:bg-white transition-all tracking-widest font-bold text-lg"
                                    required
                                    maxLength={6}
                                />
                            </div>
                ...
                <div className="text-center mt-8 pt-6 border-t border-slate-100">
                    <Link href="/admin" className="text-sm font-bold text-slate-500 hover:text-black transition-colors">
                        Back to Login
                    </Link>
                </div>
            </div>
