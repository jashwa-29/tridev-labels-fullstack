import apiClient from '@/components/admin/lib/api-client';
...
export const specialService = {
  ...
  async getAll(isAdmin = false) {
    return apiClient.get('/specialsPromotions', { params: { admin: isAdmin ? 'true' : undefined } });
  },
  ...
  async create(formData) {
    return apiClient.post('/specialsPromotions', formData, {
  ...
  async delete(id) {
    ...
    return apiClient.delete(`/specialsPromotions/${id}`);
  }
};
